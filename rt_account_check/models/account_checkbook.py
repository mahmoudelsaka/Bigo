...
class AccountCheckbook(models.Model):
    ...
    issue_check_subtype = fields.Selection(
        ...
        required=True,
        default='deferred',
        help='''* With current checks the seat generated by the payment '
        'discounted directly from the bank account and also the date of'
        'payment is not mandatory. \ n'
        '* With deferred checks the seat generated by the payment will be made'
        'against the account defined for that purpose in the company, then it will be'
        'necessary the debit entry that can be generated from the extract'
        or from the check.''',
    )
